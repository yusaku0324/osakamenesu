...
export type DashboardNotificationChannelKey = 'email' | 'line' | 'slack'
...
export type DashboardNotificationsUpdateSuccess = DashboardNotificationsSuccess
...
export type DashboardNotificationsUpdateResult =
  | DashboardNotificationsUpdateSuccess
